...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:9201 --caname ca-Provider --tls.certfiles ${PWD}/organizations/fabric-ca/providerOrg/tls-cert.pem
  set +x

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-9201-ca-Provider.pem
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9201 --caname ca-Provider -M ${PWD}/organizations/peerOrganizations/provider.mynetwork.com/peers/peer0.provider.mynetwork.com/msp --csr.hosts peer0.provider.mynetwork.com --tls.certfiles ${PWD}/organizations/fabric-ca/providerOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9201 --caname ca-Provider -M ${PWD}/organizations/peerOrganizations/provider.mynetwork.com/peers/peer0.provider.mynetwork.com/tls --enrollment.profile tls --csr.hosts peer0.provider.mynetwork.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/providerOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:9201 --caname ca-Provider -M ${PWD}/organizations/peerOrganizations/provider.mynetwork.com/users/User1@provider.mynetwork.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/providerOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://providerOrgadmin:providerOrgadminpw@localhost:9201 --caname ca-Provider -M ${PWD}/organizations/peerOrganizations/provider.mynetwork.com/users/Admin@provider.mynetwork.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/providerOrg/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:9202 --caname ca-Subscriber --tls.certfiles ${PWD}/organizations/fabric-ca/subscriberOrg/tls-cert.pem
  set +x

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-9202-ca-Subscriber.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-9202-ca-Subscriber.pem
    OrganizationalUnitIdentifier: peer
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9202 --caname ca-Subscriber -M ${PWD}/organizations/peerOrganizations/subscriber.mynetwork.com/peers/peer0.subscriber.mynetwork.com/msp --csr.hosts peer0.subscriber.mynetwork.com --tls.certfiles ${PWD}/organizations/fabric-ca/subscriberOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer1:peer1pw@localhost:9202 --caname ca-Subscriber -M ${PWD}/organizations/peerOrganizations/subscriber.mynetwork.com/peers/peer1.subscriber.mynetwork.com/msp --csr.hosts peer1.subscriber.mynetwork.com --tls.certfiles ${PWD}/organizations/fabric-ca/subscriberOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9202 --caname ca-Subscriber -M ${PWD}/organizations/peerOrganizations/subscriber.mynetwork.com/peers/peer0.subscriber.mynetwork.com/tls --enrollment.profile tls --csr.hosts peer0.subscriber.mynetwork.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/subscriberOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:9202 --caname ca-Subscriber -M ${PWD}/organizations/peerOrganizations/subscriber.mynetwork.com/peers/peer1.subscriber.mynetwork.com/tls --enrollment.profile tls --csr.hosts peer1.subscriber.mynetwork.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/subscriberOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://subscriberOrgadmin:subscriberOrgadminpw@localhost:9202 --caname ca-Subscriber -M ${PWD}/organizations/peerOrganizations/subscriber.mynetwork.com/users/Admin@subscriber.mynetwork.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/subscriberOrg/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:9203 --caname ca-Regulator --tls.certfiles ${PWD}/organizations/fabric-ca/regulatorOrg/tls-cert.pem
  set +x

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-9203-ca-Regulator.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-9203-ca-Regulator.pem
    OrganizationalUnitIdentifier: peer
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:9203 --caname ca-Regulator -M ${PWD}/organizations/peerOrganizations/regulator.mynetwork.com/peers/peer0.regulator.mynetwork.com/msp --csr.hosts peer0.regulator.mynetwork.com --tls.certfiles ${PWD}/organizations/fabric-ca/regulatorOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:9203 --caname ca-Regulator -M ${PWD}/organizations/peerOrganizations/regulator.mynetwork.com/users/User1@regulator.mynetwork.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/regulatorOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://regulatorOrgadmin:regulatorOrgadminpw@localhost:9203 --caname ca-Regulator -M ${PWD}/organizations/peerOrganizations/regulator.mynetwork.com/users/Admin@regulator.mynetwork.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/regulatorOrg/tls-cert.pem
  set +x
...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:9204 --caname ca-Orderer --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  set +x

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-9204-ca-Orderer.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-9204-ca-Orderer.pem
    OrganizationalUnitIdentifier: peer
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9204 --caname ca-Orderer -M ${PWD}/organizations/ordererOrganizations/mynetwork.com/orderers/orderer.mynetwork.com/msp --csr.hosts orderer.mynetwork.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9204 --caname ca-Orderer -M ${PWD}/organizations/ordererOrganizations/mynetwork.com/orderers/orderer.mynetwork.com/tls --enrollment.profile tls --csr.hosts orderer.mynetwork.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9204 --caname ca-Orderer -M ${PWD}/organizations/ordererOrganizations/mynetwork.com/users/Admin@mynetwork.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  set +x
