...
public class ToolUtils {
     ...
     * @return true合法
     */
    public static boolean checkYearMonthDay(String dateParam) {
        if (ToolUtils.isEmpty(dateParam)) {
            return false;
        }
        String s = dateParam.replaceAll("[/\\- ]", "");
    ...
    public static String getWebRootPath(String filePath) {
        try {
            String path = ToolUtils.class.getClassLoader().getResource("").toURI().getPath();
    ...
    public static String getFileSuffix(String fileWholeName) {
        if (ToolUtils.isEmpty(fileWholeName)) {
            return "none";
        }
     ...
     */
    public static Method getCurrentMethod(ProceedingJoinPoint proceedingJoinPoint, Signature signature) throws NoSuchMethodException {
